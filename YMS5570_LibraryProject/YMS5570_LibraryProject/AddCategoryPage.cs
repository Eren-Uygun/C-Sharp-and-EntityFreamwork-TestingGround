...
namespace YMS5570_LibraryProject
{
    public partial class AddCategoryPage : Form
    {
        ...
        private void BtnReturnAppUser_Click(object sender, EventArgs e)
        {
            AddAppUser apu = new AddAppUser();
            apu.Show();
            this.Close();
        }

        private void GoAppUser_Click(object sender, EventArgs e)
        {
            AddAppUser ap = new AddAppUser();
            ap.Show();
            this.Close();
        }
    }
